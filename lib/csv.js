...
/**
 * Parses a CSV string into header names and structured row objects.
 *
 * Handles RFC 4180 quotes, escaped quotes, CRLF/LF line breaks, whitespace trimming,
 * and formula-guard apostrophe stripping.
 *
 * @param {string} csvText
 * @returns {{ headers: string[], rows: Array<{ rowNumber: number, data: Record<string, string> }> }}
 */
